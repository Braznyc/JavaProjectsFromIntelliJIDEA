        ...
        try {
            ...
            while (true) {
                ...
                if (userAction.equals("1")) {
                    ...
                    int priority = Integer.parseInt(scanner.nextLine()); //the .parseInt( ) converts strings to integers.

                    // Validate the priority input (default to 1 if invalid)
                    priority = priority > 3 ? 1 : priority; //If priority is greater than 3, then if resets it to 1, that is the default number. If it is 1, 2 or 3 it will keep those numbers (1, 2 ou 3 that have already been save in the variable "priority").
